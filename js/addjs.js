    ...
    if (navigator.geolocation) {
        ...
        navigator.geolocation.getCurrentPosition(function (position) {
            ...
            var locPosition = new kakao.maps.LatLng(currentlat, currentlon), // 마커가 표시될 위치를 geolocation으로 얻어온 좌표로 생성합니다
                message = '<div class="nowcontainer"><div class ="nowbtn" style="padding: 0px; font-family: \'Open Sans\',\'Helvetica Neue\',Helvetica,Arial,sans-serif;">현위치</div></div>'; // 인포윈도우에 표시될 내용입니다
    ...
    function drawMarker(json) {
        ...
        geocoder.addressSearch(json.documents[0].address_name, function (result, status) {
            ...
            if (status === kakao.maps.services.Status.OK) {
                ...
                var infowindow = new kakao.maps.InfoWindow({
                    content: '<div style="width:150px;text-align:center;padding:6px 0; font-family: \'Open Sans\',\'Helvetica Neue\',Helvetica,Arial,sans-serif;">위치</div>'
                });
                infowindow.open(map, marker);
